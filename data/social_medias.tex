...
\social[github]{https://github.com/HamedMasafi}                              % optional, remove / comment the line if not wanted
...
\social[telegram]{@Hamed_Masafi}                            % optional, remove / comment the line if not wanted
