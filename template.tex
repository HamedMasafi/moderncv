...
\InputIfFileExists{data/education}
...
% \InputIfFileExists{data/experience}
\InputIfFileExists{data/languages}
\InputIfFileExists{data/computer_skills}
...
\InputIfFileExists{data/interests}
\InputIfFileExists{data/extra1}
\InputIfFileExists{data/extra2}
\InputIfFileExists{data/references}
